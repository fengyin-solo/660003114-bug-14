  ...
  <div class="bg-slate-800 rounded-lg p-4 border border-slate-700">
    ...
    <div class="relative">
      ...
      <input
        ...
        @input="store.schedulePattern(localPattern)"
        @keyup.enter="execute"
        type="text"
        placeholder="输入正则表达式..."
    ...
    <textarea
      ...
      @input="store.scheduleTestString(localTestString)"
      placeholder="输入测试字符串..."
      rows="3"
...
watch(() => store.pattern, value => {
  localPattern.value = value
})
watch(() => store.testString, value => {
  localTestString.value = value
})
</script>
